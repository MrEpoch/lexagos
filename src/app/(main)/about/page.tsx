...
export default function Page() {
  return (
    <div className="py-8">
      <HeroParallax products={dummyCardContent.map((item) => ({ title: item.title, link: "/courses", thumbnail: item.imgSrc }))} />
    ...
    About us 
        ...
        <Image src="/assets/team.jpg" alt="about" width={500} height={500} className="self-end mt-8 rounded-xl"/>
<p className="max-w-xl text-base md:text-xl mt-8">
          Lorem ipsum dolor sit amet, officia excepteur ex fugiat reprehenderit enim labore culpa sint ad nisi Lorem 
          pariatur mollit ex esse exercitation amet. Nisi anim cupidatat excepteur officia. Reprehenderit nostrud nostrud 
          ipsum Lorem est aliquip amet voluptate voluptate dolor minim nulla est proident. Nostrud officia pariatur ut officia.
        ...
        <Image src="/assets/coffee.jpg" alt="about" width={500} height={500} className="self-end mt-8 rounded-xl"/>
        </div>
      </div>
    </div>
  );
