...
export default function Footer() {
  return (
    <>
      ...
      <footer role="footer" className="w-full py-8 relative flex items-center justify-between px-4">
        <div className="w-full">
          <Link role="footer-logo" href="/" className="w-full flex items-center gap-4">
            <Image
              src="/assets/Logo.png"
              alt="Logo"
              width={80}
    ...
    justify-between items-center w-full flex-col gap-4"
          >
            ...
            <div className="flex gap-4 items-center">
              <p role="footer-follow" className="text-sm text-gray-400">Follow us on: </p>
