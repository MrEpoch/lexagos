  ...
  return (
    <main className="min-h-screen w-full pb-16 pt-32">
      <div className="flex flex-col gap-8 max-w-screen-xl h-full mx-auto w-full px-4 sm:px-6 lg:px-8 z-10">
        ...
        <Image src={course.data.imageUrl} className="sm:w-[675px] w-full object-cover self-center" alt={course.data.name} width={2000} height={2000} />
        <p className="text-lg">{course.data.description}</p>
        <Button type="button" variant="secondary" className="w-full">Enroll</Button>
      </div>
    </main>
  )
}
