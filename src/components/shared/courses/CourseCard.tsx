  ...
  return (
    <>
      {!(isAction && ip) ? (
        ...
        >
          <Card className="hover:scale-[1.01] transition-all duration-300 py-4 sm:w-[375px] w-[300px] max-[375px]:w-full">
        ...
        <Card
          role="course-card"
          className="hover:scale-[1.01] flex flex-col gap-4 transition-all duration-300 py-4 sm:w-[375px] w-[300px] max-[375px]:w-full"
        >
          <CardContent className="flex flex-col gap-2 h-full">
            <Image
              src={content.imageUrl as string}
