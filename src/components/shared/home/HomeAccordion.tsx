...
export default function HomeAccordion() {
  return (
    <div className="min-h-screen w-full flex flex-col gap-4 items-center justify-around">
      <div>
    <h3 className="text-3xl sm:text-4xl text-center font-bold mb-8">Frequently asked questions</h3>
    <Image src="/assets/question-mark.svg" alt="Question mark" width={500} height={500} className="shadow-2xl h-full object-cover transition-shadow duration-300 ease-in-out" />
  </div>
  ...
  <AccordionItem value="item-2">
    ...
    <AccordionContent>
      Yes! Most of our courses were create in years 2022-2024, so they are relatively new.
    </AccordionContent>
  </AccordionItem>
